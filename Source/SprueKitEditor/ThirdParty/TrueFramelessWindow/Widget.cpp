    ...
    : QMainWindow(parent)
{
    ...
    QLabel* titleLabel = new QLabel("SprueKit v1.0");
    QPalette lblPal(titleLabel->palette());
    lblPal.setColor(QPalette::ColorRole::Background, Qt::transparent);
    titleLabel->setPalette(lblPal);
