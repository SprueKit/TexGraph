#include "TextureHomeRibbonBuilder.h"
...
namespace SprueEditor
{
    ...
    void TextureHomeRibbonBuilder::Build(SprueKitEditor* editor)
    {

        auto ribbon = editor->GetRibbon();

        auto page = new RibbonDocumentPage(new RibbonDocumentPageType<TextureDocument>(), "Scene");
