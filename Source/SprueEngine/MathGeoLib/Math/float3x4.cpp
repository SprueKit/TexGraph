...
//#endif
    ...
    float3x4 ret;
    ret.v[0][0] = (v[1][1] * v[2][2] - v[2][1] * v[1][2]) * invDet;
    ret.v[0][1] = -(v[0][1] * v[2][2] - v[2][1] * v[0][2]) * invDet;
    ret.v[0][2] = (v[0][1] * v[1][2] - v[1][1] * v[0][2]) * invDet;
    ret.v[0][3] = -(v[0][3] * ret.v[0][0] + v[1][3] * ret.v[0][1] + v[2][3] * ret.v[0][2]);
    ret.v[1][0] = -(v[1][0] * v[2][2] - v[2][0] * v[1][2]) * invDet;
    ret.v[1][1] = (v[0][0] * v[2][2] - v[2][0] * v[0][2]) * invDet;
    ret.v[1][2] = -(v[0][0] * v[1][2] - v[1][0] * v[0][2]) * invDet;
    ret.v[1][3] = -(v[0][3] * ret.v[1][0] + v[1][3] * ret.v[1][1] + v[2][3] * ret.v[1][2]);
    ret.v[2][0] = (v[1][0] * v[2][1] - v[2][0] * v[1][1]) * invDet;
    ret.v[2][1] = -(v[0][0] * v[2][1] - v[2][0] * v[0][1]) * invDet;
    ret.v[2][2] = (v[0][0] * v[1][1] - v[1][0] * v[0][1]) * invDet;
    ret.v[2][3] = -(v[0][3] * ret.v[2][0] + v[1][3] * ret.v[2][1] + v[2][3] * ret.v[2][2]);
    return ret;
	//return copy;
}
